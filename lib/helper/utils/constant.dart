...
class Constant {
  ...
  static String hostUrl = "https://app.zerodelivery.in/";

  static String packageName = "com.zero.delivery.partner";
  static String appStoreUrl = "https://testflight.apple.com/join/zerodelivery/";
